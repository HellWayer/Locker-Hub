...
if _G.Setting["WhiteScreen"] then
    ...
    while task.wait() do
        pcall(function()
            for _,v in pairs(game.Workspace.Enemies:GetChildren()) do
                ...
                if atoMoB and MagnetActive500 then
...
spawn(function()
    while wait(.1) do
        if AutoHaki or Haki_Toggle or V1 then
            if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
            end
        end
...
spawn(function()
    pcall(function()
        while task.wait() do
            if TPStarters or autofarmV1 or AutoFarmSelectMon or atoMoB or V1 then
...
spawn(function()
    game:GetService("RunService").Stepped:Connect(function() 
        if TPStarters or autofarmV1 or AutoFarmSelectMon or atoMoB or V1 or NoClip_Toggle then
                        ...
                        repeat wait()
                            if game:GetService("Workspace").Enemies:GetChildren(Ms) then
                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                    ...
                                    cframemon = v.HumanoidRootPart.CFrame
                                    v.Head.CanCollide = false
                                    TP(cframemon * CFrame.new(0,30,0))
                                    Magnet = true
                                    Fast_Delay = true
                                else
                                    Magnet = false    
...
if OldWorld then
    SelectMonFarm = {"Default","Bandit [Lv. 5]","Monkey [Lv. 14]","Gorilla [Lv. 20]","Pirate [Lv. 35]","Brute [Lv. 45]","Desert Bandit [Lv. 60]","Desert Officer [Lv. 70]","Snow Bandit [Lv. 90]","Snowman [Lv. 100]","Chief Petty Officer [Lv. 120]","Sky Bandit [Lv. 150]","Dark Master [Lv. 175]","Toga Warrior [Lv. 250]","Gladiator [Lv. 275]","Military Soldier [Lv. 300]","Military Spy [Lv. 325]","Fishman Warrior [Lv. 375]","Fishman Commando [Lv. 400]","God's Guard [Lv. 450]","Shanda [Lv. 475]","Royal Squad [Lv. 525]","Royal Soldier [Lv. 550]","Galley Pirate [Lv. 625]","Galley Captain [Lv. 650]"}
...
tap1:AddToggle("Auto Farm ( Select )", _G.Setting["FarmSelectMon"], function(v)
    if SelectToolWeapon == "" or SelectToolWeapon == nil then
        ...
        SelectMonster = SelectMonsterOld
        AutoFarmSelectMon = v
        AutoHaki = v
        Fast_Delay = v
    end
...
spawn(function()
    while wait(0.0075) do 
        pcall(function()
            if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and atoMoB or Fast_Delay and Fast_Delay_Click_Custom  then
                AttackNoCD(0)
            end
...
spawn(function()
    while wait(0.5) do 
        pcall(function()
            if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and Fast_Delay_Click_Custom then
                AttackNoCD(1)
                wait()
                AttackNoCD(0)
            end
...
function EquipWeaponMisc(ToolSe)
    if game.Players.LocalPlayer.Backpack:FindFirstChild(ToolSe) then
        local tool = game.Players.LocalPlayer.Backpack:FindFirstChild(ToolSe)
        game.Players.LocalPlayer.Character.Humanoid:EquipTool(tool)
    end
...
tap2:AddSeperator("Setting Move Farm")

local DropWeaponMisc = tap2:AddDropdown("Weapon", WeaponMisc, function(v)
    SelectToolWeaponMisc = v
end)

tap2:AddButton("Refresh Weapon", function()
    DropWeaponMisc:Clear()
    for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
        if v:IsA("Tool") then
            wait(.1)
            DropWeaponMisc:Add(v.Name)
        end
    end
    for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
        if v:IsA("Tool") then
...
tap2:AddSeperator("Auto Function ( Simple )")
                    ...
                    if v.Humanoid.Health > 0 then
                        repeat wait()
                            pcall(function()
                                ...
                                TP2(v.HumanoidRootPart.CFrame * CFrame.new(0,0,15))
                                v.Humanoid:ChangeState(11)
                                v.Head.CanCollide = false
                                Fast_Delay = true
...
function Cake2()
    pcall(function()
        if (game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]")) then
                    ...
                    if v.Humanoid.Health > 0 then
                        repeat wait()
                            pcall(function()
                                ...
                                EquipWeaponMisc(SelectToolWeaponMisc)
                                TP(v.HumanoidRootPart.CFrame * CFrame.new(0,40,40))
                                v.Humanoid:ChangeState(11)
                                v.Head.CanCollide = false
                                Fast_Delay = true 
                            end)
            ...
            TP2(CFrame.new(-2154.03369140625, 70.01808166503906, -12398.90234375))
            Fast_Delay = false
        end
    end)
end
...
spawn(function()
    pcall(function()
        while task.wait() do
            if TPStarters or autofarmV1 or AutoFarmSelectMon or atoMoB then
                if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Root") then
                    local BodyV = Instance.new("BodyVelocity")
                    BodyV.Name = "BodyClip"
                    BodyV.Parent = game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Root") 
                    BodyV.MaxForce = Vector3.new(10000000, 10000000, 10000000)
                    BodyV.Velocity = Vector3.new(0, 0, 0)
                end
            else
                if game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Root") then
                    game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Root"):Destroy()
                end
            end
        end
    end)
...
tap4:AddDropdown("Select Teleport", TPselect, function(lol)
    TweenNameMap = lol
    game.StarterGui:SetCore("SendNotification", {
        Title = "Notification System", 
        Text = "✅ : Teleport: ".. tostring(lol) .."",
        Duration = 5
    })
end)

tap4:AddSeperator("Support Warp Teleports")

tap4:AddButton("Mansion ( Warp )", function()
    if OldWorld then
        game.Players.LocalPlayer:Kick("Not Support ( ThreeWorld )")
    elseif NewWorld then
        game.Players.LocalPlayer:Kick("Not Support ( ThreeWorld )")
    elseif ThreeWorld then
...
tap4:AddButton("Start Teleport", function()
    TPStarters = true
end)

tap4:AddButton("Stop Teleport", function()
    TPStarters = false
    wait(.5)
    TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
end)
...
tap5:AddToggle("Auto Kill Raid", false, function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Notification System", 
        Text = "Coming Soon",
        Duration = 25
...
tap6:AddButton("Reset Stat [ 2500 F ]", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

tap6:AddButton("Reroll race [ 3000 F ]", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)

tap6:AddSeperator("Abilities")

tap6:AddButton("Skyjump", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end)

tap6:AddButton("Buso Haki", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end)

tap6:AddButton("Soru", function()
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
end)

tap6:AddButton("Ken Haki", function()
